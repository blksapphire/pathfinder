...
echo "🔧 Fixing grid, speed, cell info, and UI..."

# ========================
# 1. Updated layout – collapsible panel, better styling
# ========================
...
<RelativeLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- Toggle button to show/hide signal panel -->
    <com.google.android.material.floatingactionbutton.FloatingActionButton
        ...
        android:contentDescription="Show/hide network info"
...
# Create a drawable for panel background (rounded, translucent)
mkdir -p android/app/src/main/res/drawable
cat > android/app/src/main/res/drawable/panel_background.xml << 'XML'
<?xml version="1.0" encoding="utf-8"?>
<shape xmlns:android="http://schemas.android.com/apk/res/android">
    <corners android:topLeftRadius="16dp" android:topRightRadius="16dp"/>
    <solid android:color="#DD222222"/>
</shape>
XML

# ========================
# 2. New MainActivity – all fixes
# ========================
